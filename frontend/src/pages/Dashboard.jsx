...
export default function Dashboard() {
  ...
  const lineData = {
    ...
    datasets: [
      { label: 'Messages', data: [65, 78, 90, 112, 135, 150], borderColor: '#7c3aed', backgroundColor: 'rgba(124,58,237,0.1)', fill: true, tension: 0.4 },
      { label: 'Delivered', data: [60, 72, 85, 105, 128, 142], borderColor: '#22c55e', backgroundColor: 'rgba(34,197,94,0.1)', fill: true, tension: 0.4 }
    ]
  };
